          ...
          <CustomScrollbars className="gx-layout-sider-scrollbar">
            <Menu
              ...
              <MenuItemGroup key="main" className="gx-menu-group" title={<IntlMessages id="sidebar.main"/>}>
                ...
                <SubMenu key="school" className={this.getNavStyleSubMenuClass(navStyle)} title={
                  <span>
                  <i className="icon icon-all-contacts"/>
                   <IntlMessages id="sidebar.school"/>
                  </span>}>

                  <Menu.Item key="main/school/school">
                    <Link to="/main/school/school">
                      <IntlMessages id="sidebar.create.school"/></Link>
                  </Menu.Item>

                  <Menu.Item key="main/school/branch">
                    <Link to="/main/school/branch">
                      <IntlMessages id="sidebar.create.branch"/>
                    </Link>
                  </Menu.Item>
                ...
                <Menu.Item key="main/metrics">
                  <Link to="/main/metrics"><i className="icon icon-apps"/>
                    <IntlMessages id="sidebar.staff"/></Link>
                </Menu.Item>
                ...
                <Menu.Item key="main/logout">
                  <Link to="/main/logout"><i className="icon icon-signin"/>
                    <IntlMessages id="sidebar.logout"/></Link>
                </Menu.Item>
